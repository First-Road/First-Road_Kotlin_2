...
import com.senai.first_road.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_editar_imagem, R.id.nav_trilhas, R.id.nav_sair, R.id.nav_suporte
            ), drawerLayout
        )
